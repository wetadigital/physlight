...
used, instead~\parencite{meng2015}: saturated primary colors correspond to narrow
...
is required~\parencite{schroedinger19}, and can be detrimental in rendering systems based
