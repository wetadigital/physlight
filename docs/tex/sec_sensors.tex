...
\begin{figure}
{
\noindent\resizebox{\linewidth}{!}{\input{figures/ciexyz1931.pgf}}
...
\noindent\resizebox{\linewidth}{!}{\input{figures/Red_Mysterium_X.pgf}}\\
\setlength{\tabcolsep}{.35em}
...
\small
{
\noindent\resizebox{\linewidth}{!}{\input{figures/Canon_1DMarkIII.pgf}}\\
\setlength{\tabcolsep}{.35em}
\begin{minipage}{.3\textwidth}
\centering
\begin{tabular}{c|r@{.}l | r@{.}l | r@{.}l}
...
\small
{
\noindent\resizebox{\linewidth}{!}{\input{figures/Canon_5DMarkII.pgf}}\\
\setlength{\tabcolsep}{.35em}
\begin{minipage}{.3\textwidth}
\centering
\begin{tabular}{c|r@{.}l | r@{.}l | r@{.}l}
