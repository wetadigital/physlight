...
In this document we focus on the specification of \glspl{illuminant} and
...
As we have just seen, radiometric quantities can be used to measure brightness in terms of \index{radiant power}\emph{radiant power}.
...
Conversely, \index{spectral distribution} spectral distributions carrying the same amount
