...
We hope our glossary in \cref{sec:main} might help clarify 
potential issues arising from our use of movie-making jargon.
...
Light rays are the path segments\footnote{
	...
	on the accuracy needed. Famously, the movie~\cite{interstellar2014} instead did 
	need to capture this effect accurately, and a specialized rendering system was 
	developed for the show. The task was complex enough that the Nobel laureate
	Kip Thorne was included as part of the team developing this technology. 
	The second is that variations in the index of refraction of the medium that
	the light is traversing can also bend the light paths. This is a 
	substantially more common effect, for example it's the origin of the 
	\textsl{mirage} phenomenon. While there are several research projects that
	have built renderers able to capture this effect, the computational costs
	associated with this capability are high enough to make it impractical for
	more everyday use
