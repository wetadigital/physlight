...
light source in terms of \gls{photometric} units, i.e., units which represent brightness as
perceived by a \gls{human observer}, rather than \gls{radiometric} ones 
...
is a measure of the power absorbed by the object, not the power of the radiation it emits in the visible range\footnote{This is effectively the concept of  
	...
	a contemporary \gls{LED} lightbulb would be somewhere between 
