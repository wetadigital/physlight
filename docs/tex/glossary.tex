...
\newglossaryentry{aperture}
{
	...
	description={In an optical system, an opening (usually mounted inside the 
		barrel of a camera lens) that admits light. 
		This is also called \textsl{entrance pupil} or a \textsl{diaphragm}.
		...
		usually in \unit{\milli\meter},
		or its ratio to the focal length is given, called the \textsl{aperture number}}
}
