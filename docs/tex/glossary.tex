...
units: \textit{kelvin} $[\si{\kelvin}]$ (temperature), \textsl{second}
$[\si{\second}]$ (time), \textsl{metre} $[\si{\meter}]$ (length),
\textsl{kilogram} $[\si{\kilogram}]$ (mass), \textsl{candela} $[\si{\candela}]$
(luminous intensity), \textsl{mole} $[\si{\mole}]$ (amount of substance) and
\textsl{ampere} $[\si{\ampere}]$ (electric current)}]{si}{si}{International
System of Units}
