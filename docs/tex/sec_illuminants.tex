...
It is possible to get a formulation with every-day ranged constants and values in play by expressing the temperature in kilokelvins $[\si{\kilo\kelvin}]$ and the wavelength in micrometers $[\si{\micro\meter}]$:
