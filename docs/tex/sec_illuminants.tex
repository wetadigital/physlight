...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures/blackbody.pgf}}
...
\resizebox{\linewidth}{!}{\input{figures/chromas.pgf}}
\end{minipage}\hfill
\begin{minipage}{.4\linewidth}
\resizebox{\linewidth}{!}{\input{figures/chromas_enlarge.pgf}}
\end{minipage}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures/commonilluminants.pgf}}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures/illuminantf1-6.pgf}}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures/illuminantf7-9.pgf}}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures/illuminantf10-12.pgf}}
...
{
\small
\noindent\resizebox{\linewidth}{!}{\input{figures/illuminantd.pgf}}\\
...
{
\centering
\noindent\resizebox{\linewidth}{!}{\includegraphics{figures/roscolux.pdf}}
