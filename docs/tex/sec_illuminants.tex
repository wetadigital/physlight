...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures_built/blackbody.pgf}}
...
\resizebox{\linewidth}{!}{\input{figures_built/chromas.pgf}}
\end{minipage}\hfill
\begin{minipage}{.4\linewidth}
\resizebox{\linewidth}{!}{\input{figures_built/chromas_enlarge.pgf}}
\end{minipage}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures_built/commonilluminants.pgf}}
...
\begin{inconstruction}
	Update the plot to not include D55 and D75
\end{inconstruction}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures_built/illuminantf1-6.pgf}}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures_built/illuminantf7-9.pgf}}
...
\small
\centering
\resizebox{\linewidth}{!}{\input{figures_built/illuminantf10-12.pgf}}
...
{
\small
\noindent\resizebox{\linewidth}{!}{\input{figures_built/illuminantd.pgf}}\\
...
{
\centering
\noindent\resizebox{\linewidth}{!}{\input{figures_built/roscolux.pgf}}
